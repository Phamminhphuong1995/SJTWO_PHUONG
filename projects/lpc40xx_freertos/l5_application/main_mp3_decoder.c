...
void set_up_decoder(){
  // clock
  gpio__construct_with_function(1,0,GPIO__FUNCTION_2);  
  // MOSI
  gpio__construct_with_function(1,1,GPIO__FUNCTION_2);  
  // MISO
  gpio__construct_with_function(1,4,GPIO__FUNCTION_2);  
  // CS
  gpio__construct_with_function(4,28,GPIO__FUNCITON_0_IO_PIN);  
  GPIO__set_as_output(1,0);
  GPIO__set_as_output(1,1);
  GPIO__set_as_input(1,4);
  GPIO__set_as_output(4,28);
}